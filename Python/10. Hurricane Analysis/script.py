...
# List of months each hurricane occurred
months = ['October', 'September', 'September', 'November', 'August', 'September', 'September', 'September', 'September', 'September', 'September', 'October', 'September', 'August', 'September', 'September', 'August', 'August', 'September', 'September', 'August', 'October', 'September', 'September', 'July', 'August', 'September', 'October', 'August', 'September', 'October', 'September', 'September', 'October']

# List of years each hurricane occurred
years = [1924, 1928, 1932, 1932, 1933, 1933, 1935, 1938, 1953, 1955, 1961, 1961, 1967, 1969, 1971, 1977, 1979, 1980, 1988, 1989, 1992, 1998, 2003, 2004, 2005, 2005, 2005, 2005, 2007, 2007, 2016, 2017, 2017, 2018]

# List of maximum sustained winds for each hurricane
max_sustained_winds = [165, 160, 160, 175, 160, 160, 185, 160, 160, 175, 175, 160, 160, 175, 160, 175, 175, 190, 185, 160, 175, 180, 165, 165, 160, 175, 180, 185, 175, 175, 165, 180, 175, 160]

# List of areas affected by each hurricane
...
# List of recorded damages for each hurricane
damages = ['Damages not recorded', '100M', 'Damages not recorded', '40M', '27.9M', '5M', 'Damages not recorded', '306M', '2M', '65.8M', '326M', '60.3M', '208M', '1.42B', '25.4M', 'Damages not recorded', '1.54B', '1.24B', '7.1B', '10B', '26.5B', '6.2B', '5.37B', '23.3B', '1.01B', '125B', '12B', '29.4B', '1.76B', '720M', '15.1B', '64.8B', '91.6B', '25.1B']

# List of recorded deaths for each hurricane
deaths = [90,4000,16,3103,179,184,408,682,5,1023,43,319,688,259,37,11,2068,269,318,107,65,19325,51,124,17,1836,125,87,45,133,603,138,3057,74]

# Function to convert damage data to a common scale
...
# Apply the conversion function to the damages list
updated_damages = convert_damages_data(damages)

# Function to create a dictionary for each hurricane with its details
...
# Create a dictionary containing details of each hurricane
hurricanes = create_dictionary(names, months, years, max_sustained_winds, areas_affected, updated_damages, deaths)

# Function to create a dictionary grouping hurricanes by year
...
# Create a dictionary grouping hurricanes by year
hurricanes_by_year = create_year_dictionary(hurricanes)
print(hurricanes_by_year[1932])

# Function to count the number of occurrences of each affected area
...
# Count the occurrences of each affected area
...
# Find and print the most affected area and its count
max_area, max_area_count = most_affected_area(affected_areas_count)
print(max_area,max_area_count)

# Function to find the hurricane with the highest mortality
...
# Find and print the hurricane with the highest mortality and its count
max_mortality_cane, max_mortality = highest_mortality(hurricanes)
print(max_mortality_cane, max_mortality)

# Function to categorize hurricanes by mortality levels
...
# Categorize hurricanes by mortality levels
hurricanes_by_mortality = categorize_by_mortality(hurricanes)
print(hurricanes_by_mortality[5])

# Function to find the hurricane with the highest damage
...
# Find and print the hurricane with the highest damage and its count
max_damage_cane, max_damage = highest_damage(hurricanes)
print(max_damage_cane, max_damage)

# Function to categorize hurricanes by damage levels
...
# Categorize hurricanes by damage levels
